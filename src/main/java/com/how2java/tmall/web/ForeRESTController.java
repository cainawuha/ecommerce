...
public class ForeRESTController {
    ...
    public Object createOrder(@RequestBody Order order,HttpSession session) throws NoSuchAlgorithmException, InvalidKeyException {
        User user =(User)  session.getAttribute("user");
        if(null==user)
            return Result.fail("未登录");
        ...
        map.put("total", total);
        map.put("x_fp_sequence",x_fp_sequence);
        map.put("x_fp_timestamp",x_fp_timestamp);
        map.put("x_fp_hash",x_fp_hash);
